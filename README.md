...
<head>
    ...
    <title>Nombre del Negocio - Servicios Profesionales</title>
    <style>
        /* Variables de colores - Fáciles de cambiar */
        :root {
            --color-primary: #4A90E2;    /* Color principal - Cambia este color */
            --color-secondary: #50E3C2;  /* Color secundario - Cambia este color */
            --color-dark: #333333;       /* Color oscuro para textos */
            --color-light: #F5F5F5;      /* Color claro para fondos */
            --color-grey: #777777;       /* Color gris para textos secundarios */
        }
